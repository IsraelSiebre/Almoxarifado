...
public class SecurityConfig {
    ...
    private final String roleAdmin = Role.ADMIN.toString();
    private final String roleAluno = Role.ALUNO.toString();
    private final String roleInstrutor = Role.INSTRUTOR.toString();
